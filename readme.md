...
## Задание
Угадай число Программа загадывает случайное число от 1 до 50. Пользователь пытается угадать, программа подсказывает «Загаданное число больше» или «меньше». Игра заканчивается, когда число угадано, выводится количество попыток.
## Решение
```
using System;
